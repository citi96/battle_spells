...
namespace Battle_Spells.Api.Migrations
{
    ...
    [Migration("20250425153712_cambio primary key")]
    partial class cambioprimarykey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Battle_Spells.Api.Entities.PlayerHero", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Battle_Spells.Api.Entities.PlayerCard", b =>
                {
                    b.HasOne("Battle_Spells.Api.Entities.Card", "Card")
                        .WithOne()
                        .HasForeignKey("Battle_Spells.Api.Entities.PlayerCard", "CardId")
